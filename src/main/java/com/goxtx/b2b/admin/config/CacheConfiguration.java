package com.goxtx.b2b.admin.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("goXTXB2BAdmin");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("goXTXB2BAdmin");
        ...
        config.getMapConfigs().put("com.goxtx.b2b.admin.domain.*", initializeDomainMapConfig(jHipsterProperties));
